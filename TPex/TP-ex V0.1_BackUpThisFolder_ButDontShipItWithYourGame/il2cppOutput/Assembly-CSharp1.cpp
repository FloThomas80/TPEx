...
IL_0051:
	{
		...
		int32_t L_14 = ___1_updateSuccessFlags;
...
IL_0069:
	...
	}
	{
		...
		L_26 = XRHand_GetJoint_mDD5E7D4F45C9701AF8911EA4394F258CB5E68035((&___1_hand), L_25, NULL);
...
IL_002b:
	...
	{
		int32_t L_24;
		L_24 = XRHandJoint_get_id_m22F4DAECB98383D196AA9549A8682B73270AB394_inline((&___1_joint), NULL);
	...
	}
	{
		...
		Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971* L_26 = ___2_parentPose;
		Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971 L_27 = ___0_originPose;
		...
		Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971 L_31 = ___0_originPose;
...
IL_00b1:
	{
		...
		Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971* L_39 = ___2_parentPose;
		...
		Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971* L_46 = ___2_parentPose;
		...
		// if (cacheParentPose)
		bool L_55 = ___3_cacheParentPose;
		if (!L_55)
		{
			goto IL_00f7;
		}
	...
	{
		// parentPose = pose;
		Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971* L_56 = ___2_parentPose;
...
IL_00f7:
	...
	}
	{
		...
		bool L_87;
		L_87 = XRHandJoint_TryGetLinearVelocity_m3BC24DBDEB210B51568D21317B1B3574A6B57F6B((&___1_joint), (&V_6), NULL);
		if (!L_87)
		{
			goto IL_01e8;
		}
...
IL_01a7:
	...
	}
	{
		...
		bool L_94;
		L_94 = XRHandJoint_TryGetAngularVelocity_mA486ED68AE5883EC4EE22A4403457E5F3F64CF63((&___1_joint), (&V_7), NULL);
		if (!L_94)
		{
			goto IL_01e8;
		}
