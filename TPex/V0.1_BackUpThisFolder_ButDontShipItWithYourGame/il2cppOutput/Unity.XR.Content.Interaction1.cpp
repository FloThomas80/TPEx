...
IL_00c3:
	...
	{
		// if (!m_PositionDriven || freshCheck)
		bool L_29 = __this->___m_PositionDriven_57;
	...
	}
	{
		...
		TrackedRotation_t66CAAA8384E11A2A6F9BDA0CE9FDF8A333A3F6A3* L_31 = (&__this->___m_PositionAngles_59);
...
IL_00f5:
	...
	{
		// if (!m_UpVectorDriven)
		bool L_34 = __this->___m_UpVectorDriven_58;
		if (L_34)
		{
			goto IL_010c;
		}
...
IL_0116:
	...
	}
	{
		...
		TrackedRotation_t66CAAA8384E11A2A6F9BDA0CE9FDF8A333A3F6A3* L_40 = (&__this->___m_UpVectorAngles_60);
...
IL_0142:
	{
		// if (m_UpVectorDriven || freshCheck)
		bool L_42 = __this->___m_UpVectorDriven_58;
	...
	}
	{
		...
		TrackedRotation_t66CAAA8384E11A2A6F9BDA0CE9FDF8A333A3F6A3* L_44 = (&__this->___m_ForwardVectorAngles_61);
...
IL_015f:
	{
		// if (m_PositionDriven)
		bool L_46 = __this->___m_PositionDriven_57;
		if (!L_46)
		{
			goto IL_0173;
		}
	}
	{
		...
		TrackedRotation_t66CAAA8384E11A2A6F9BDA0CE9FDF8A333A3F6A3* L_47 = (&__this->___m_PositionAngles_59);
...
IL_0173:
	...
	}
	{
		...
		TrackedRotation_t66CAAA8384E11A2A6F9BDA0CE9FDF8A333A3F6A3* L_50 = (&__this->___m_UpVectorAngles_60);
...
IL_0196:
	{
		...
		float L_54 = __this->___m_BaseKnobRotation_62;
		TrackedRotation_t66CAAA8384E11A2A6F9BDA0CE9FDF8A333A3F6A3* L_55 = (&__this->___m_UpVectorAngles_60);
		float L_56;
		L_56 = TrackedRotation_get_totalOffset_m8335EC621910854624A3139B652A87FA934B264D(L_55, NULL);
		TrackedRotation_t66CAAA8384E11A2A6F9BDA0CE9FDF8A333A3F6A3* L_57 = (&__this->___m_ForwardVectorAngles_61);
		float L_58;
		L_58 = TrackedRotation_get_totalOffset_m8335EC621910854624A3139B652A87FA934B264D(L_57, NULL);
		float L_59 = __this->___m_TwistSensitivity_54;
		TrackedRotation_t66CAAA8384E11A2A6F9BDA0CE9FDF8A333A3F6A3* L_60 = (&__this->___m_PositionAngles_59);
		float L_61;
		...
		// if (m_ClampedMotion)
		bool L_62 = __this->___m_ClampedMotion_49;
		if (!L_62)
		{
			goto IL_01e6;
		}
	}
	{
		...
		float L_63 = V_6;
		float L_64 = __this->___m_MinAngle_51;
		float L_65 = __this->___m_MaxAngle_50;
		float L_66;
...
IL_01e6:
	{
		...
		float L_68 = V_6;
		float L_69 = __this->___m_MinAngle_51;
		float L_70 = __this->___m_MaxAngle_50;
		float L_71 = __this->___m_MinAngle_51;
...
IL_0031:
	{
		// if (m_Handle != null)
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_7 = __this->___m_Handle_47;
...
IL_0010:
	...
	}
	{
		...
		float L_4 = __this->___m_MaxAngle_50;
		...
		float L_9 = V_1;
		float L_10 = __this->___m_AngleIncrement_52;
		float L_11;
...
IL_005b:
	{
		...
		__this->___m_Value_48 = L_16;
		// m_OnValueChange.Invoke(m_Value);
		ValueChangeEvent_t0481CAE6722F3B57C58A7EFCB81AAFE9F6F30E17* L_17 = __this->___m_OnValueChange_55;
		float L_18 = __this->___m_Value_48;
		NullCheck(L_17);
...
IL_000e:
	{
		...
		V_0 = L_3;
		// if (m_Handle != null)
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_4 = __this->___m_Handle_47;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_5;
	...
	}
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_6 = __this->___m_Handle_47;
		NullCheck(L_6);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_7;
...
IL_005d:
	{
		...
		float L_26 = __this->___m_PositionTrackedRadius_53;
		...
		float L_39 = __this->___m_PositionTrackedRadius_53;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void XRKnob_OnValidate_mB08147D8DC4B8E860E6B7D09696CC81082CC9F22 (XRKnob_t515317ECC5A9200F3EA297D8D17848C033F4F126* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		float L_1 = __this->___m_Value_48;
		float L_2;
		L_2 = Mathf_Clamp01_mA7E048DBDA832D399A581BE4D6DED9FA44CE0F14_inline(L_1, NULL);
		__this->___m_Value_48 = L_2;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void XRLever_UpdateValue_m9E36BF1D16C71BEADDAB1BC298C8580663F989FA (XRLever_t4B47F0D1FA640CD4039834A6E98DB3B6E3821510* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		float L_8 = V_1;
		float L_9 = __this->___m_MinAngle_51;
		float L_10 = __this->___m_MaxAngle_50;
		float L_11;
...
IL_0042:
	{
		...
		float L_12 = V_1;
		float L_13 = __this->___m_MaxAngle_50;
		float L_14 = __this->___m_MinAngle_51;
		float L_15;
...
IL_0029:
	{
		// m_Value = isOn;
		bool L_6 = ___0_isOn;
		__this->___m_Value_48 = L_6;
		// if (m_Value)
		bool L_7 = __this->___m_Value_48;
		if (!L_7)
		{
			goto IL_0045;
		}
	}
	{
		...
		UnityEvent_tDC2C3548799DBC91D1E3F3DE60083A66F4751977* L_8 = __this->___m_OnLeverActivate_52;
		NullCheck(L_8);
...
IL_0045:
	{
		...
		UnityEvent_tDC2C3548799DBC91D1E3F3DE60083A66F4751977* L_9 = __this->___m_OnLeverDeactivate_53;
		NullCheck(L_9);
...
IL_0050:
	...
	{
		bool L_11 = __this->___m_LockToValue_49;
	...
	{
		// SetHandleAngle(m_Value ? m_MaxAngle : m_MinAngle);
		bool L_13 = __this->___m_Value_48;
		G_B13_0 = __this;
		if (L_13)
		{
			G_B14_0 = __this;
...
IL_0073:
	{
		float L_15 = __this->___m_MaxAngle_50;
		G_B15_0 = L_15;
		G_B15_1 = G_B14_0;
	}
...
IL_0026:
	{
		...
		float L_8 = __this->___m_MaxAngle_50;
		...
		float L_17 = __this->___m_MinAngle_51;
...
IL_0009:
	{
		// m_Toggled = value;
		bool L_1 = ___0_value;
		__this->___m_Toggled_56 = L_1;
		// if (m_Toggled)
		bool L_2 = __this->___m_Toggled_56;
		if (!L_2)
		{
			goto IL_0026;
		}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void XRPushButton_Start_m223746CF20D6979F62B77951D69DD249B789FF44 (XRPushButton_t7CB9021CB94F13079A4E33251ED2F2D6E66D8DF3* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_2 = __this->___m_Button_46;
		NullCheck(L_2);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_3;
		L_3 = Transform_get_position_m69CD5FA214FDAE7BB701552943674846C220FDE1(L_2, NULL);
		__this->___m_BaseButtonPosition_58 = L_3;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void XRPushButton_OnEnable_mEAD16D16110DBF83BF6875C8992B22745DE3DFCA (XRPushButton_t7CB9021CB94F13079A4E33251ED2F2D6E66D8DF3* __this, const RuntimeMethod* method) 
{
	...
	{
		// SetButtonHeight(-m_PressDistance);
		float L_1 = __this->___m_PressDistance_47;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void XRPushButton_EndHover_mDE942B9C5F9E34BFA025F383C0DFFDF108868BAB (XRPushButton_t7CB9021CB94F13079A4E33251ED2F2D6E66D8DF3* __this, HoverExitEventArgs_tFFBECDDAF90BF90AA3B7282FAEF1D8E5D19A5AD6* ___0_args, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		bool L_6 = __this->___m_ToggleButton_51;
		if (!L_6)
		{
			goto IL_003d;
		}
	...
	{
		bool L_7 = __this->___m_Toggled_56;
		if (!L_7)
		{
			goto IL_003d;
		}
	...
	{
		// SetButtonHeight(-m_PressDistance);
		float L_8 = __this->___m_PressDistance_47;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void XRPushButton_ProcessInteractable_m4C2CE6AA75532791DC9DBA9C88B96DD08B889799 (XRPushButton_t7CB9021CB94F13079A4E33251ED2F2D6E66D8DF3* __this, int32_t ___0_updatePhase, const RuntimeMethod* method) 
{
	...
	{
		// if (m_HoveringInteractors.Count > 0)
		Dictionary_2_t498B0175DACE25227D7797802E7144770FE39DE6* L_2 = __this->___m_HoveringInteractors_59;
		NullCheck(L_2);
		int32_t L_3;
...
IL_0034_1:
			{
				...
				Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_13 = __this->___m_BaseButtonPosition_58;
				Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_14;
				...
				float L_18;
				L_18 = fabsf(L_17);
				float L_19 = __this->___m_ButtonSize_50;
			...
			}
			{
				...
				float L_22;
				L_22 = fabsf(L_21);
				float L_23 = __this->___m_ButtonSize_50;
...
IL_0096_1:
			...
			}
			{
				...
				float L_30 = __this->___m_ButtonOffset_49;
				NullCheck(L_27);
...
IL_00bb_1:
			...
			}
			{
				...
				float L_36 = __this->___m_ButtonOffset_49;
				float L_37;
...
IL_00fe:
	{
		...
		float L_41 = V_0;
		float L_42 = __this->___m_PressDistance_47;
		float L_43 = __this->___m_PressBuffer_48;
		float L_44;
		...
		bool L_45 = __this->___m_ToggleButton_51;
		if (L_45)
		{
			goto IL_0127;
		}
	...
	{
		float L_46 = V_0;
		float L_47 = __this->___m_PressDistance_47;
...
IL_0127:
	{
		float L_48 = V_0;
		float L_49 = __this->___m_PressDistance_47;
		float L_50 = __this->___m_PressBuffer_48;
...
IL_013b:
	{
		...
		float L_51 = V_0;
		float L_52 = __this->___m_PressBuffer_48;
		float L_53;
		...
		float L_54 = V_2;
		float L_55 = __this->___m_PressDistance_47;
		__this->___m_Value_57 = ((float)(L_54/L_55));
		// if (m_ToggleButton)
		bool L_56 = __this->___m_ToggleButton_51;
		if (!L_56)
		{
			goto IL_01a2;
		}
	...
	{
		// if (!m_Pressed)
		bool L_58 = __this->___m_Pressed_55;
		if (L_58)
		{
			goto IL_01cd;
		}
	...
	{
		// m_Toggled = !m_Toggled;
		bool L_59 = __this->___m_Toggled_56;
		__this->___m_Toggled_56 = (bool)((((int32_t)L_59) == ((int32_t)0))? 1 : 0);
		// if (m_Toggled)
		bool L_60 = __this->___m_Toggled_56;
		if (!L_60)
		{
			goto IL_0195;
		}
	...
	{
		// m_OnPress.Invoke();
		UnityEvent_tDC2C3548799DBC91D1E3F3DE60083A66F4751977* L_61 = __this->___m_OnPress_52;
		NullCheck(L_61);
...
IL_0195:
	{
		// m_OnRelease.Invoke();
		UnityEvent_tDC2C3548799DBC91D1E3F3DE60083A66F4751977* L_62 = __this->___m_OnRelease_53;
		NullCheck(L_62);
...
IL_01a2:
	...
	{
		// m_OnPress.Invoke();
		UnityEvent_tDC2C3548799DBC91D1E3F3DE60083A66F4751977* L_65 = __this->___m_OnPress_52;
		NullCheck(L_65);
...
IL_01ba:
	{
		// if (m_Pressed)
		bool L_66 = __this->___m_Pressed_55;
		if (!L_66)
		{
			goto IL_01cd;
		}
	...
	{
		// m_OnRelease.Invoke();
		UnityEvent_tDC2C3548799DBC91D1E3F3DE60083A66F4751977* L_67 = __this->___m_OnRelease_53;
		NullCheck(L_67);
...
IL_01cd:
	{
		// m_Pressed = pressed;
		bool L_68 = V_1;
		__this->___m_Pressed_55 = L_68;
		// if (m_Pressed)
		bool L_69 = __this->___m_Pressed_55;
		if (!L_69)
		{
			goto IL_01ed;
		}
	...
	{
		// m_OnValueChange.Invoke(m_Value);
		ValueChangeEvent_t6ABB63D6EC8E3745851A79F2AA32B8550933F214* L_70 = __this->___m_OnValueChange_54;
		float L_71 = __this->___m_Value_57;
		NullCheck(L_70);
...
IL_0020:
	{
		...
		float* L_6 = L_5;
		float L_7 = *((float*)L_6);
		float L_8 = __this->___m_ButtonOffset_49;
		float L_9 = __this->___m_PressDistance_47;
		*((float*)L_6) = (float)((float)il2cpp_codegen_add(L_7, ((float)il2cpp_codegen_subtract(L_8, ((float)il2cpp_codegen_multiply(L_9, (0.5f)))))));
		...
		float L_14 = __this->___m_ButtonSize_50;
		float L_15 = __this->___m_PressDistance_47;
		float L_16 = __this->___m_ButtonSize_50;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void XRSlider_UpdateSliderPosition_m816CAAC7F9DAECFD0C0822B62B195B71680F4D87 (XRSlider_t3AB802BD5E80A8534A5BF9D2F710238AF3213E51* __this, const RuntimeMethod* method) 
{
	...
	float V_0 = 0.0f;
	{
		...
		float L_6 = __this->___m_MinPosition_49;
		float L_7 = __this->___m_MaxPosition_48;
		float L_8 = __this->___m_MinPosition_49;
		float L_9;
...
IL_000f:
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_2 = __this->___m_Handle_46;
		NullCheck(L_2);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_3;
		L_3 = Transform_get_localPosition_mA9C86B990DF0685EA1061A120218993FDCC60A95(L_2, NULL);
		V_0 = L_3;
		// handlePos.z = Mathf.Lerp(m_MinPosition, m_MaxPosition, value);
		float L_4 = __this->___m_MinPosition_49;
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_8 = __this->___m_Handle_46;
